%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description:
%   SINS/GPS Intergration Navigation System test version 3.0
...
% Allocate memory for matrix or array
...
for k = 2 : nn : kTime
    ...
    % Indirect Kalman filter：输出矫正法（只更新导航输出，未对惯导系统进行校正）
    qbn_est = qdelphi(qbn, kf.Xk(1:3));
    vn_est  = vn - kf.Xk(4:6);
    pos_est(kk,:) = pos - kf.Xk(7:9);
    ...
    err(kk, :) = [qq2phi(qbn_est, qbn_ref)', (vn_est - vn_ref)', (pos_est(kk,:)' - pos_ref(kk,:)')', t];
